...
// Nodes names
#define RECEIVER_NODE_NAME       "cam_v2_cam_pdu_descriptions_receiver"
#define SENDER_NODE_NAME         "cam_v2_cam_pdu_descriptions_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "/CAM_in"
#define SENDER_ROS_TOPIC          "/CAM_out"

// Network
#define DEFAULT_SENDER_IP          "127.0.0.1" 
#define DEFAULT_SENDER_UDP_PORT    1111          
#define DEFAULT_RECEIVER_UDP_PORT  2001
