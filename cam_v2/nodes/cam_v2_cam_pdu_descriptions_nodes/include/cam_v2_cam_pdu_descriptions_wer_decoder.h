 ...
 *
 */
#ifndef CAM_V2_CAM_PDU_DESCRIPTIONS_WER_DECODER
#define CAM_V2_CAM_PDU_DESCRIPTIONS_WER_DECODER
...
namespace wind
{
    namespace decoder_cam_v2_cam_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              bool decode(cam_v2_cam_pdu_descriptions_msgs::CAM* ros, const uint8_t *buffer);
            #else
              bool decode(cam_v2_cam_pdu_descriptions_msgs::msg::CAM* ros, const uint8_t *buffer);
            #endif
...
#endif //CAM_V2_CAM_PDU_DESCRIPTIONS_WER_DECODER