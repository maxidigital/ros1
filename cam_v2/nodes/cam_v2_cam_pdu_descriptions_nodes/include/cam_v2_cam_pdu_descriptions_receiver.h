...
namespace wind_ros
{
	...
	#else
	  class Receiver_cam_v2_cam_pdu_descriptions : public rclcpp::Node
    #endif
    {
    public:
		 ...
		 */
        #if WIND_ROS_VERSION == 1
		Receiver_cam_v2_cam_pdu_descriptions() : node_handle_("~"),
			publisher_(nullptr),
			...
			busy_(false)
		#else
		Receiver_cam_v2_cam_pdu_descriptions() : Node("receiver_cam_v2_cam_pdu_descriptions"),
			messages_counter_(0),
			slogger_(nullptr),
			debug_(false),
			busy_(false)
    ...
    private:        	
		...
		#else
		  rclcpp::Publisher<cam_v2_cam_pdu_descriptions_msgs::msg::CAM>::SharedPtr publisher_;
          rclcpp::Publisher<cam_v2_cam_pdu_descriptions_msgs::msg::CAM>::SharedPtr mirror_publisher_;
		#endif
		...
		bool            debug_;
		bool            busy_;
		wind::decoder_cam_v2_cam_pdu_descriptions::WerDecoder* decoder_;
    };
