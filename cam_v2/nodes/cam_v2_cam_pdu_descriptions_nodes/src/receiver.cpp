...
public:
    ...
    void run()
    {
        ...
        #if WIND_ROS_VERSION == 1 
          receiver_ = new wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions();
        #else
          receiver_ = std::make_shared<wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions>();
        #endif
        ...
        slogger_->print() << "Registering message name(" << tools::bold(tools::cyan("CAM")) << ")";
...
private:
      ...
      wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions* receiver_;
    #else
      std::shared_ptr<wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions> receiver_;
    #endif
...
int main(int argc, char** argv) {	
    ...
    slogger->print() << "| " << tools::cyan("Message name") << "       : " << tools::yellow("CAM");
