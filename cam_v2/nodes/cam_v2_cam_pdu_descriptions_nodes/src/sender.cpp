...
public:
    ...
    void run() {
        // Modules
          ...
          wind::wind_ros::Sender_cam_v2_cam_pdu_descriptions* sender_ = new wind::wind_ros::Sender_cam_v2_cam_pdu_descriptions();
		#else
          slogger_->print() << "Starting " << tools::cyan("ROS2") << " node";
		  auto sender_ = std::make_shared<wind::wind_ros::Sender_cam_v2_cam_pdu_descriptions>();
	    #endif
